...
home: true
lang: zh-CN
title: 深入理解 CPython 虚拟机
description: 深入理解 CPython 虚拟机
heroText: Dive into CPython # 这是标题
tagline: 深入理解 CPython 虚拟机 # 这是副标题
# actionText: 快速上手 →
...
- [深入理解 python 虚拟机：黑科技的幕后英雄——描述器](obsy/01class.md)
- [深入理解 python 虚拟机：描述器的王炸应用](obsy/02application.md)
- [深入理解 python 虚拟机：描述器实现原理与源码分析](obsy/03decriptor.md)
- [深入理解 python 虚拟机：魔术方法之数学计算](obsy/05magicmethod.md)
- [深入理解 python 虚拟机：花里胡哨的魔术方法](obsy/06magicmethod02.md)

### 继承体系

- [深入理解 python 虚拟机：多继承与 mro](obsy/04mro.md)

### Python 新特性

- [Python 3.14 新特性](new/314.md)
