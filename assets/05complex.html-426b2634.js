import{_ as p}from"./qrcode2-187b7271.js";import{_ as t,r as e,o,c,a as n,d as s,b as l,e as i}from"./app-6b5e6c63.js";const u="/dive-into-cpython/assets/23-int-7eca77db.png",r="/dive-into-cpython/assets/24-int-a34bd21e.png",k={},d=i(`<h1 id="深入理解-python-虚拟机-复数-complex-的实现原理及源码剖析" tabindex="-1"><a class="header-anchor" href="#深入理解-python-虚拟机-复数-complex-的实现原理及源码剖析" aria-hidden="true">#</a> 深入理解 Python 虚拟机：复数（complex）的实现原理及源码剖析</h1><p>在本篇文章当中主要给大家介绍在 cpython 虚拟机当中是如何实现 复数 complex 这个数据类型的，这个数据类型在 cpython 当中一应该是一个算比较简单的数据类型了，非常容易理解。</p><h2 id="复数数据结构" tabindex="-1"><a class="header-anchor" href="#复数数据结构" aria-hidden="true">#</a> 复数数据结构</h2><p>在 cpython 当中对于复数的数据结构实现如下所示：</p><div class="language-c line-numbers-mode" data-ext="c"><pre class="language-c"><code><span class="token keyword">typedef</span> <span class="token keyword">struct</span> <span class="token punctuation">{</span>
